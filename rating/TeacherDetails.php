...
<div class="container">
	<h2>Teacher Detail Page</h2>
	<?php

	include 'Rating.php';
	$rating = new Rating();
	$TeacherDetails = $rating->getProduct($_GET['teacher_id']);
	$average = $rating->getRatingAverage($_GET['teacher_id']);
	$count = $rating->getRatingTotal($_GET['teacher_id']);
	...
	<div class="row">
		...
		<div class="col-sm-4">
		<h4 style="margin-top:10px;"><?php echo $Teacher["username"]; ?></h4>
<?php
   ...
   <?php
	...
	<div >
		<div class="row">
			...
			<div class="col-sm-3">
				<button type="button" id="rateProduct" class="btn btn-secondary btn-sm <?php if(empty($_SESSION['userid'])){echo $settingClass;}  ?>">Rate this teacher</button>
			</div>
		</div>
		<div class="row">
			<div class="col-sm-7">
						...
						<div class="col-sm-12">
							<form id="ratingForm" method="POST">
								<div class="form-group">
									...
									<input type="hidden" class="form-control" id="teacher_id" name="teacher_id" value="<?php echo $_GET['teacher_id']; ?>">
								...
								<div class="form-group">
									<label for="name">UserName</label>
										<input type="text" class="form-control"  id = "reviwer" name="reviwer" placeholder="Username" required>
								</div>
				...
				<?php
				$TeacherRating = $rating->getTeacherRating($_GET['teacher_id']);
				foreach($TeacherRating as $rating){
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="myModalLabel">Login to rate this teacher</h5>
